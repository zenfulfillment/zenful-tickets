...
export function ProviderIcon({
  ...
  switch (provider) {
    ...
    case "openrouter":
      // OpenRouter's official mark — two arrows split by a router junction.
      // Important: paths 1 & 3 are open arcs that should be STROKED only
      // (fill="none"), and paths 2 & 4 are closed arrowhead triangles that
      // should be FILLED only. Setting both fill and stroke to currentColor
      // at the root renders the arcs as filled blobs, so we split them
      // explicitly. Tintable via currentColor.
      return (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
